...
public class Home extends Fragment implements AppConstants.urlConstants, AppConstants.SharedConstants, ResponseListener, NotifiyArrayListChange, SwipeRefreshLayout.OnRefreshListener, GpsNotifier, EndlessRecyclerView.Pager, EndlessRecyclerViewNew.Pager {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (extras1 != null) {
            int flag = extras1.getInt("soccerkey");
            Log.d("mykey", flag + "");
        }
        ...
        //get bundel data from previous screen.
        ...
        } else if (bundle.getString("isFromExplorar") != null) {
            navigation = bundle.getString("navi");
            if (navigation.equalsIgnoreCase("buddy")) {
                displayView(0);
            } else if (navigation.equals("pick")) {
...
//show showcaseview for app tutorial screen only once when user download app
...
// change banner if perticular city banner as per the gps location.
    ...
    //show pickup tutorial screen first time when pickup create.
...
//buddyp empty view for pickup when internet connection unavailble
    ...
    //buddyp empty view for buddyup when internet connection unavailble
    ...
    //update currunt location to server
...
//concate skills to show in buddyup list
    ...
    //get pickup list from server and show on view
...
//if gps is disable show setting alert
   ...
   /* private void showBottomLoaderView(){
    ...
    //view for pickup and buddyup listing
...
// show empty view when internet is not there
