...
//internet connectivty check
    ...
    //check currunt version android for force update.
    ...
    //get currunt version number
    private int getVersionNumber() {
        return BuildConfig.VERSION_CODE;
    }

    //navigate screen to login or signup as per the sessioin
    ...
    //screen animation for loading splash screen.
...
//                }
    ...
    public void onStart() {
        super.onStart();
        //branch deeplink for push notifications android.
    ...
    //download latest play service version from app store.
