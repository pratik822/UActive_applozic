...
import com.uactiv.fragment.Explorar_;
...
import com.uactiv.fragment.ScheduleFragment;
...
public class MainActivity extends AppCompatActivity implements BannerImageListener, FragmentDrawer.FragmentDrawerListener, AppConstants.SharedConstants, ResponseListener, AppConstants.urlConstants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            maps = ( Map<String, Object>)getIntent().getSerializableExtra("itemparams"); //Obtaining data
        }
    ...
    private void getRatingList() {
        if (Utility.isConnectingToInternet(MainActivity.this)) {
            try {
                ...
                param.put("iduser", SharedPref.getInstance().getStringVlue(MainActivity.this, userId));
                RequestHandler.getInstance().stringRequestVolley(MainActivity.this, AppConstants.getBaseUrl(SharedPref.getInstance().getBooleanValue(MainActivity.this, isStaging)) + checkrating, param, this, 1);
            } catch (Exception e) {
                e.printStackTrace();
        ...
        switch (position) {
            case 0:
                ...
                Bundle bn=new Bundle();
                 bn.putSerializable("itemparams",(Serializable) maps);
    ...
    private void showBadgeUpdateDialog(String newBadge) {
        if (!AppConstants.isGestLogin(MainActivity.this)) {
            Utility.setScreenTracking(this, AppConstants.SCREEN_TRACKING_ID_BADGESPOPUP);
        } else {
            Utility.setScreenTracking(this, "Guest login Badges Pop Up screen");
        }

        final Dialog badgeDialog = new Dialog(this, R.style.Theme_Dialog);
        ...
        SharedPref.getInstance().setSharedValue(MainActivity.this, badge, newBadge);
