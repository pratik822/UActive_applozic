...
public class CreateProfile extends Activity implements View.OnClickListener,
    ...
    String firstname = "", lastname = "", signinemailed = "", signinpassed = "";
                                                        ...
                                                        try {
                                                            ...
                                                            if (email.isEmpty()) {
                                                               /* Intent intent = new Intent(CreateProfile.this, MainActivity.class);
                                                                intent.putExtra("itemparams", (Serializable) stringMap);
                                                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                                                startActivity(intent);
                                                                finish();*/
                                                                setalertDialog(stringMap);
                                                                Log.e(TAG + " itemparams", stringMap.toString());
                                                            } else {
                                                                if (stringMap != null) {
                                                                    Log.e(TAG + " send", stringMap.toString());
                                                                    imageUploads(stringMap);
                                                                }
                                                            }
    ...
    private void imageUploads(Map<String, Object> param) {
        //Extras
        if (Utility.isNullCheck(SharedPref.getInstance().getStringVlue(CreateProfile.this, gcm_token))) {
            param.put("device_id", SharedPref.getInstance().getStringVlue(CreateProfile.this, gcm_token));
        } else {
    ...
    public void successResponse(String successResponse, int flag) {
        ...
        switch (flag) {
            ...
            case 11:
                Log.d("myregistration", new Gson().toJson(jsonObject));
                break;
    ...
    public void registration() {
        ...
        try {
            firstname = this.getIntent().getStringExtra("firstname");
            lastname = this.getIntent().getStringExtra("lastname");
            signinemailed = this.getIntent().getStringExtra("signinemailed");
            signinpassed = this.getIntent().getStringExtra("signinpassed");
...
//                            if (signinemailed.getText().toString().trim().matches(AppConstants.emailPattern)) {
                        if (signinemailed.trim().matches(AppConstants.emailPattern) || signinemailed.trim().matches(AppConstants.emailPatternTwoDecimalPoint)) {
                            if (signinpassed.length() >= 4) {
                                if (Utility.isConnectingToInternet(CreateProfile.this)) {
                                    try {
                                        Map<String, String> stringMap = new HashMap<>();
                                        stringMap.put("email", signinemailed.trim());
                                        progressWheel.setVisibility(View.VISIBLE);
                                        progressWheel.startAnimation();
                                        email = signinemailed;
                                        RequestHandler.getInstance().stringRequestVolley(CreateProfile.this, AppConstants.getBaseUrl(SharedPref.getInstance().getBooleanValue(CreateProfile.this, isStaging)) + checkEmail, stringMap, this, 11);
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                ...
                                Utility.showToastMessage(CreateProfile.this, "Please enter atleast 4 characters");
                            }
                        } else {
                            Utility.showToastMessage(CreateProfile.this, "Please enter valid email address");
                        }
                    } else {
                        Utility.showToastMessage(CreateProfile.this, "Please enter email address");
                    }
                } else {
                    Utility.showToastMessage(CreateProfile.this, "Please enter lastName");
                }
            } else {
                Utility.showToastMessage(CreateProfile.this, "Please enter firstName");
            }
    ...
    public void setalertDialog(final Map<String, Object> param) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(CreateProfile.this);
        ...
        // final GifImageView   gif = (GifImageView) view.findViewById(R.id.gifLoader);
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             /*       gif.setVisibility(View.VISIBLE);
                    ...
                    Toast.makeText(CreateProfile.this, "please provide email", Toast.LENGTH_SHORT).show();
                }
