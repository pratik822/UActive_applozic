...
public class BuddyUpDetailsActivity extends Activity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (intent.getStringExtra("pickupevent") != null) {
                ...
                map.put("fb_id", this.getIntent().getStringExtra("userfbid"));
                map.put("user_id", SharedPref.getInstance().getStringVlue(BuddyUpDetailsActivity.this, userId));
                RequestHandler.getInstance().stringRequestVolley(BuddyUpDetailsActivity.this, AppConstants.getBaseUrlFacebook(SharedPref.getInstance().getBooleanValue(BuddyUpDetailsActivity.this, isStaging)) + facebookUser, map, BuddyUpDetailsActivity.this, 4);
                Log.d("fb", facebookUser);
    ...
    // bind activity with mutual friends
     ...
     */
//tutorial screen for buddyup request
...
//for getting currunt acess tokan for api
...
//                    intent.putExtra("userid", jsonArray.get(0).getUserid() + "");
            ...
            case 3:
                ...
                if (mutualObject.has("context")) {
                    if (mutualObject.getJSONObject("context").has("all_mutual_friends")) {
                        mutual_recycle.setVisibility(View.VISIBLE);
                        tvFacebookSize.setVisibility(View.VISIBLE);
                        JSONArray mutualfriends = new JSONArray(mutualObject.getJSONObject("context").getString("all_mutual_friends"));
...
// get mutual friends list
    private void getMutualfriendApi(String tokan, String userid) {
        ...
        map.put("user_id", fbuserid);
        RequestHandler.getInstance().stringRequestVolley(BuddyUpDetailsActivity.this, AppConstants.getBaseUrlFacebook(SharedPref.getInstance().getBooleanValue(BuddyUpDetailsActivity.this, isStaging)) + getMutualFriend, map, this, 3);


    }

    //set buddyup details functions
