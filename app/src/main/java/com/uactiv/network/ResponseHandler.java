    ...
    public void storeProfileInfo(Context context, JSONObject response) throws JSONException {
        ...
        if (response != null) {
            ...
            if (profileInfo != null) {
                ...
                SharedPref.getInstance().setSharedValue(context, image, profileInfo.optString("image"));
...
//                }
    ...
    public synchronized ArrayList<NotifyModel> getNotificationList(Context context, JSONObject jsonObject, AppContactService appContactService) {
    ...
    private synchronized ArrayList<NotifyModel> getNotification(Context context, JSONArray getNotification, String title, boolean isUpComing,
        ...
        for (int i = 0; i < getNotification.length(); i++) {
            ...
            notifyModel.setImage(favObj.optString("image"));
